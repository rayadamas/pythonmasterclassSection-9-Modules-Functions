...
for zone in os.listdir('/Windows/System32'):
    fileList.insert(tkinter.END, zone) # adds file name
# scroll bar
...
timeFrame = tkinter.LabelFrame(mainWindow, text="Time") # adds border as well
...
mainWindow.mainloop() # kicks off process
