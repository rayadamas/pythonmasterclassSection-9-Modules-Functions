...
# print("Naive local time {}".format(local_time)) # w/o timezone info
...
gap_time = datetime.datetime(2015, 10, 25, 1, 30, 0, 0) # time falls within time clocks were put back in UK
print(gap_time)
